...
<head>
    ...
    <title>Q2-Calculadora de IMC</title>
    <style>
        .indice {
            margin-top: 20px;
            display: flex;
            ...
            if ($altura >= 120 && $peso >= 46) {
                ...
                <table>
                    ...
                    for ($altura = 120; $altura <= 210; $altura++) {
                        ...
                        echo "<th>$altura</th>";
                        for ($peso = 46; $peso <= 120; $peso++) {
                            // Calcular o IMC para cada combinação de altura e peso
                            $imc = calcularIMC($peso, $altura);

                            // Obter a cor da célula com base no grau de IMC
                            $cor = obterGrauIMC($imc)[1];

                            // Definir o atributo "title" para aparecer ao passar o mouse sobre a célula
